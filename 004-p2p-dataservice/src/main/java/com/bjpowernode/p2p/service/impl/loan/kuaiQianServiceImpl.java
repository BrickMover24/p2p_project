...
public class kuaiQianServiceImpl implements kuaiQianService {
    ...
    @Override
    public Map<String, String> makeKuaiQianRequestParam(String orderNo,String yuan, String name, String phone, String remoteAdd) {
        ...
        String bgUrl = "http://47.113.198.114:9999/kq/notify";
        //网关版本，固定值：v2.0,该参数必填。
        String version =  "v2.0";
